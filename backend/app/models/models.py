...
class UserAddress(Base):
    ...
    # 新字段（v2，2026-05-05 地址改造）
    consignee_name = mapped_column(String(20), nullable=True)
    consignee_phone = mapped_column(String(11), nullable=True)
    province = mapped_column(String(20), nullable=True)
    province_code = mapped_column(String(6), nullable=True)
    city = mapped_column(String(20), nullable=True)
    city_code = mapped_column(String(6), nullable=True)
    district = mapped_column(String(20), nullable=True)
    district_code = mapped_column(String(6), nullable=True)
    detail = mapped_column(String(120), nullable=True)
