...
API_BASE = "https://newbb.bangbangvip.com/autodev/3b7b999d-e51c-4c0d-8f6e-baf90cd26857/api"
H5_BASE = "https://newbb.bangbangvip.com/autodev/3b7b999d-e51c-4c0d-8f6e-baf90cd26857"
ADMIN_BASE = "https://newbb.bangbangvip.com/autodev/3b7b999d-e51c-4c0d-8f6e-baf90cd26857/admin"
TIMEOUT = 30
...
class TestUploadsPath:
    def test_uploads_route_reachable(self, http):
        ...
        resp = http.get(
            f"https://newbb.bangbangvip.com/autodev/3b7b999d-e51c-4c0d-8f6e-baf90cd26857/uploads/",
            timeout=TIMEOUT,
        )
...
class TestH5StaticAssets:
    def test_h5_next_route_works(self, http):
        ...
        if asset_url.startswith("/"):
            asset_url = f"https://newbb.bangbangvip.com{asset_url}"
