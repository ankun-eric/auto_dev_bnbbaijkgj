...
# -*- coding: utf-8 -*-
"""
[361] 部署 PRD｜门店管理列�?- 固定列优�?v1.0
- 服务器：newbb.test.bangbangvip.com（ubuntu / Newbang888�?
- DEPLOY_ID�?b099ed3-7175-4a78-91f4-44570c84ed27
- 项目基础URL：https://6b099ed3-7175-4a78-91f4-44570c84ed27.noob-ai.test.bangbangvip.com
- 改动范围：仅 admin-web 一�?.tsx 文件�? 处改�?
- 部署策略：git pull �?�?build/up admin-web 容器 �?验证页面可达
"""
import sys
import time
import paramiko
...
# 严禁硬编�?token：从环境变量 GIT_TOKEN 读取（部署脚本运行前 export�?
GIT_TOKEN = _os.environ.get("GIT_TOKEN", "")
GIT_REPO = "codeup.aliyun.com/6a05a6159b7ce0afb00c035e/6b099ed3-7175-4a78-91f4-44570c84ed27.git"
...
def main():
    ...
    # 验证 page.tsx �?fixed: 'left'/'right' 字样
    log("\n--- 阶段 2：源代码改动确认 ---")
    ...
    log(f"  gateway 容器: {gw_name or '(未找�?'}")
    if gw_name:
