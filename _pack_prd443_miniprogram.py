...
文件命名：miniprogram_prd443_<YYYYMMDDHHMMSS>_<4位hex>.zip
"""
import os
import sys
import io
...
LOG_PATH = os.path.join(PROJECT_ROOT, "_pack_prd443_miniprogram.log")
...
def main() -> int:
    ...
    zip_name = f"miniprogram_prd443_{ts}_{rand}.zip"
