#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""[PRD-CARE-MODE-OPTIM-V4] 打包小程序 zip 并放入 gateway-nginx 静态目录(/data/static/apk/)供下载。"""
...
fname = f"miniprogram_care_optim_v4_{ts}_{rnd}.zip"
out = ROOT / fname
...
with open(ROOT / "_mp_care_v4_url.txt", "w", encoding="utf-8") as f:
    f.write(url)
ssh.close()
