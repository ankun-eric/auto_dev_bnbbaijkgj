...
def make_zip_filename():
    ...
    return f"miniprogram_bug410_{ts}_{h}.zip"
...
def main():
    ...
    print("[verify] OK (app.json / app.js / project.config.json present)")

    print("[sftp] uploading...")
    remote_path = sftp_upload(zip_path, zip_name)
