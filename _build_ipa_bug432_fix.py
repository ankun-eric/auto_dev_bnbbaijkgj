#!/usr/bin/env python3
"""[Bug-432-fix] Flutter iOS IPA 远程构建脚本（GitHub Actions + GH Release）。"""
import os
import sys
import time
import json
...
LOG_FILE = r"C:\auto_output\bnbbaijkgj\_build_ipa_bug432fix.log"
...
def gen_version_tag():
    ...
    return f"ios-bug432fix-v{ts}-{suffix}"
...
def main():
    ...
    log("=" * 60)
    log("Bug-432-fix: Flutter iOS IPA build via GitHub Actions")
    log("=" * 60)
