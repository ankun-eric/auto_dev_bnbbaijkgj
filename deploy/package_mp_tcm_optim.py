"""TCM 体质测评功能优化 — 打包小程序 zip 并上传到服务器 static/downloads。"""
import os
import sys
import time
import zipfile
...
MP_ZIP_NAME = f"miniprogram_tcm_optim_{int(time.time())}.zip"
...
def build_mp_zip(local_root, out_path):
...
def main():
    ...
    build_mp_zip(local_root, local_zip)
