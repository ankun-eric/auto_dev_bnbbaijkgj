"""积分商城 v1.1 - 打包小程序 zip 并上传到服务器 static/downloads。"""
import os
import sys
import secrets
import zipfile
...
ZIP_NAME = f"miniprogram_points_v11_{ts}_{rand4}.zip"
...
def main():
    ...
    with zipfile.ZipFile(local_zip, "r") as zf:
        ...
        has_index_js = "pages/points-mall/index.js" in names
        has_index_wxml = "pages/points-mall/index.wxml" in names
        print(f"  root app.json=OK, points-mall/index.js={has_index_js}, index.wxml={has_index_wxml}")
        assert has_index_js and has_index_wxml, "points-mall pages missing from zip"
