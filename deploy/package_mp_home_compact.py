"""首页顶部紧凑化 - 打包小程序 zip 并上传到服务器 static/downloads。"""
import os
import sys
import secrets
import zipfile
...
ZIP_NAME = f"miniprogram_home_compact_{ts}_{rand4}.zip"
...
def main():
    ...
    with zipfile.ZipFile(local_zip, "r") as zf:
        ...
        has_home = "pages/home/index.wxml" in names
        print(f"  root app.json=OK, home wxml={has_home}")
