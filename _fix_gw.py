...
def run(cmd, timeout=300):
    ...
    return o
# 检查 gateway 当前网络
run("docker inspect gateway-nginx --format '{{range $k,$v := .NetworkSettings.Networks}}{{$k}}{{println}}{{end}}'")
# 列出 6b099ed3 相关网络
run("docker network ls | grep 6b099ed3")
# 把 gateway 加入新网络
run("docker network connect 6b099ed3-7175-4a78-91f4-44570c84ed27_6b099ed3-7175-4a78-91f4-44570c84ed27-network gateway-nginx 2>&1 || echo 'already connected'")
# 测试
time.sleep(2)
